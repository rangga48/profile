export const dict = {
  en: {
    ...
    hero: {
      greeting: "Hi, I'm Rangga 👋",
      desc1:
        "Frontend Developer with hands-on experience in building and maintaining responsive web applications. Skilled in JavaScript and TypeScript, with a strong focus on creating clean, scalable, and user-friendly interfaces.",
      desc2:
        "Experienced in working with modern frontend frameworks, integrating REST APIs, and collaborating with cross-functional teams (UI/UX, Backend, QA). Proven ability to manage multiple projects simultaneously while maintaining high code quality and performance.",
      location: "Bandung, Indonesia",
      available: "Available for new projects and open to work",
    },
    about: {
      title: "About Me",
      subtitle: "Curious about me? Here you have it:",
      p1: "Hi, I'm Rangga Putra — a Frontend Developer based in Bandung, Indonesia, with a passion for building clean, responsive, and user-friendly web applications.",
      p2: "My journey in web development started back in 2022 when I interned at a government agency, and since then I haven't looked back. I've grown from debugging PHP apps to managing up to 9 active products simultaneously as a professional frontend developer — and I genuinely enjoy every bit of the challenge.",
      p3: "I specialize in Angular and TypeScript, with solid experience in Laravel, Bootstrap, Tailwind CSS, and REST API integration. I care deeply about writing readable, performant code and delivering interfaces that feel great to use.",
      p4: "Currently, I'm a Frontend Developer at PT. Adhikari Invoasi Indonesia, where I work closely with UI/UX designers and backend teams to ship high-quality features across multiple products. Before that, I freelanced for 2+ years, completing over 30 web projects for clients across various industries.",
      p5: "A few quick things about me:",
      ul1: [
        "Bachelor's in Informatics Engineering — Politeknik Pos Indonesia",
      ...
      p6: "One last thing, I'm available for freelance work, so feel free to reach out and say hello! I promise I don't bite 😉",
    },
    skills: {
      title: "Skills",
    ...
    experience: {
      ...
      awh: {
        ...
        tasks: [
          "Built and maintained scalable, responsive web applications across multiple product lines in a fast-paced development environment.",
          "Contributed to approximately 70% of active project development, playing a key role in feature delivery and product enhancements.",
          "Managed development tasks across up to 9 concurrent products, ensuring timely delivery and consistent code quality.",
          "Reduced application bugs by up to 50% through proactive debugging, code improvements, and better development practices.",
          "Identified and resolved critical bugs while optimizing application performance, improving load time and overall user experience.",
          "Integrated frontend systems with RESTful APIs to enable seamless and efficient data communication.",
          "Collaborated closely with UI/UX designers and backend engineers to deliver high-quality, user-centric features.",
          "Optimized application performance and improved maintainability through structured and scalable frontend architecture.",
        ],
      },
      vaganza: {
        ...
        tasks: [
          "Designed and developed a full-featured donation platform with an integrated CMS using Laravel, MySQL, and Eloquent ORM.",
          "Built dynamic, responsive web pages from UI/UX mockups using HTML, Bootstrap, CSS, and SCSS.",
          "Partnered with UI/UX designers to evaluate and validate technical feasibility of proposed designs.",
          "Coordinated with clients and developers to align on project requirements, goals, and deliverables",
          "Oversaw the complete development lifecycle from design to deployment, ensuring cross-browser compatibility.",
        ],
      },
      diskominfo: {
        ...
        tasks: [
          "Assisted in maintaining and debugging legacy PHP-based applications to ensure system stability",
          "Gathered and analyzed user requirements to support system improvements and feature development",
          "Developed an Employee Attendance Information System to streamline internal administrative processes.",
          "Contributed to system optimization and minor feature enhancements.",
        ],
      },
    },
    work: {
    ...
    contact: {
      title: "Get In Touch",
      subtitle:
        "What’s next? Feel free to reach out to me if youre looking for Frontend Developer, have a query, or simply want to connect.",
      platforms: "You may also find me on these platforms!",
      footer: "© 2025 | Designed and coded with ❤️ by Rangga",
    },
  },
  id: {
    nav: {
    ...
    hero: {
      greeting: "Halo, saya Rangga 👋",
      desc1:
        "Frontend Developer dengan pengalaman langsung dalam membangun dan memelihara aplikasi web yang responsif. Berpengalaman di JavaScript dan TypeScript, dengan fokus kuat pada pembuatan antarmuka yang bersih, terukur, dan ramah pengguna.",
      desc2:
        "Berpengalaman bekerja dengan framework frontend modern, mengintegrasikan REST API, dan berkolaborasi dengan tim lintas disiplin (UI/UX, Backend, QA). Terbukti mampu mengelola beberapa proyek secara bersamaan sambil menjaga kualitas kode dan performa tinggi.",
      location: "Bandung, Indonesia",
      available: "Tersedia untuk proyek baru dan terbuka untuk pekerjaan",
    },
    about: {
      title: "Tentang Saya",
      subtitle: "Ingin tahu tentang saya? Ini dia:",
      p1: "Halo, saya Rangga Putra — seorang Frontend Developer yang berbasis di Bandung, Indonesia, dengan hasrat untuk membangun aplikasi web yang bersih, responsif, dan mudah digunakan.",
      p2: "Perjalanan saya dalam web development dimulai pada tahun 2022 ketika magang di sebuah instansi pemerintah, dan sejak saat itu saya terus berkembang. Saya telah tumbuh dari sekadar memperbaiki bug aplikasi PHP hingga mengelola 9 produk aktif secara bersamaan sebagai frontend developer profesional — dan saya sangat menikmati setiap tantangannya.",
      p3: "Saya berspesialisasi di Angular dan TypeScript, dengan pengalaman solid di Laravel, Bootstrap, Tailwind CSS, dan integrasi REST API. Saya sangat peduli tentang menulis kode yang mudah dibaca, performen, dan memberikan antarmuka yang nyaman digunakan.",
      p4: "Saat ini, saya bekerja sebagai Frontend Developer di PT. Adhikari Invoasi Indonesia, berkolaborasi erat dengan desainer UI/UX dan tim backend untuk menghasilkan fitur berkualitas tinggi di berbagai produk. Sebelumnya, saya bekerja lepas (freelance) selama lebih dari 2 tahun, menyelesaikan lebih dari 30 proyek web untuk berbagai klien industri.",
      p5: "Beberapa fakta singkat tentang saya:",
      ul1: [
        "S1 Teknik Informatika — Politeknik Pos Indonesia",
        "Terbuka untuk peluang freelance",
      ],
      ul2: [
        "Saat ini membangun menggunakan Angular, TypeScript & Laravel",
        "Berbasis di Bandung, selalu senang untuk terhubung",
      ],
      p6: "Satu hal lagi, saya tersedia untuk pekerjaan lepas, jadi jangan ragu untuk menghubungi dan menyapa! Tenang saja, saya tidak menggigit 😉",
    },
    skills: {
      title: "Keahlian",
      subtitle: "Keahlian, alat, dan teknologi yang saya kuasai:",
    },
    experience: {
      title: "Pengalaman",
      subtitle:
      ...
      awh: {
        ...
        date: "Jan 2024 - April 2026",
        tasks: [
          "Membangun dan memelihara aplikasi web yang skalabel dan responsif di berbagai lini produk dalam lingkungan pengembangan yang cepat.",
          "Berkontribusi pada sekitar 70% pengembangan proyek aktif, memainkan peran utama dalam perilisan fitur dan peningkatan produk.",
          "Mengelola tugas pengembangan hingga 9 produk secara bersamaan, memastikan pengiriman tepat waktu dan kualitas kode yang konsisten.",
          "Mengurangi bug aplikasi hingga 50% melalui debugging proaktif, perbaikan kode, dan praktik pengembangan yang lebih baik.",
          "Mengidentifikasi dan menyelesaikan bug kritis sekaligus mengoptimalkan performa aplikasi, meningkatkan waktu muat dan pengalaman pengguna secara keseluruhan.",
          "Mengintegrasikan sistem frontend dengan RESTful API untuk memungkinkan komunikasi data yang lancar dan efisien.",
          "Berkolaborasi erat dengan desainer UI/UX dan backend engineer untuk menghasilkan fitur berkualitas tinggi yang berfokus pada pengguna.",
          "Mengoptimalkan performa aplikasi dan meningkatkan kemudahan pemeliharaan melalui arsitektur frontend yang terstruktur dan skalabel.",
        ],
      },
      vaganza: {
        role: "Full-Stack Web Developer (Magang)",
        date: "Jul 2023 - Okt 2023",
        tasks: [
          "Merancang dan mengembangkan platform donasi berfitur lengkap dengan CMS terintegrasi menggunakan Laravel, MySQL, dan Eloquent ORM.",
          "Membangun halaman web dinamis dan responsif dari mockup UI/UX menggunakan HTML, Bootstrap, CSS, dan SCSS.",
          "Bermitra dengan desainer UI/UX untuk mengevaluasi dan memvalidasi kelayakan teknis dari desain yang diusulkan.",
          "Berkoordinasi dengan klien dan pengembang untuk menyelaraskan kebutuhan proyek, tujuan, dan hasil akhir.",
          "Mengawasi siklus pengembangan secara menyeluruh dari desain hingga rilis, memastikan kompatibilitas lintas browser.",
        ],
      },
      diskominfo: {
        ...
        tasks: [
          "Membantu memelihara dan men-debug aplikasi lama berbasis PHP untuk memastikan stabilitas sistem.",
          "Mengumpulkan dan menganalisis kebutuhan pengguna untuk mendukung perbaikan sistem dan pengembangan fitur.",
          "Mengembangkan Sistem Informasi Presensi Karyawan untuk menyederhanakan proses administrasi internal.",
          "Berkontribusi pada pengoptimalan sistem dan peningkatan fitur minor.",
        ],
      },
    },
    work: {
    ...
    contact: {
      title: "Hubungi Saya",
      subtitle:
        "Apa selanjutnya? Silakan hubungi saya jika Anda mencari<br /> Frontend Developer, punya pertanyaan, atau sekadar ingin terhubung.",
      platforms: "Anda juga dapat menemukan saya di platform berikut!",
      footer: "© 2025 | Didesain dan dikodekan dengan ❤️ oleh Rangga",
    },
  },
};
